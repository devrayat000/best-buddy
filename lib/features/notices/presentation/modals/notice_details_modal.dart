...
class _NoticeDetailsModalState extends State<NoticeDetailsModal> {
  ...
  //   try {
  //     final noticeDoc = await noticeRef.doc(widget.noticeId).get();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: Text('Notice details will be displayed here.'),
      ),
    );
    // return Dialog(
    //   child: Container(
    ...
    //                   onPressed: () {
    //                     context.pop();
    //                     context.go('/notices/edit/${_notice!.id}',
    //                         extra: _notice);
    //                   },
    //                   icon: const Icon(
    //                     Icons.edit,
  ...
  //                     FirestoreBuilder(ref: _notice., builder: builder)
  //                     Text(
  //                       'Created by: ${_notice!.createdBy.name}',
  //                       style: TextStyle(
  //                         fontSize: 14,
  ...
  //           onPressed: () async {
  //             try {
  //               await noticeRef.doc(_notice!.id!).delete();
